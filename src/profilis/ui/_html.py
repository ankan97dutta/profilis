"""Shared dashboard HTML (single source for Flask, Sanic, FastAPI)."""
...
<head>
  ...
  <script>
    ...
    function download(path){
      fetchJSON(basePath + path).then(data=>{
...
<body>
  <div class="wrap">
    <div class="report-section">
      <a href="#" style="color:var(--muted);text-decoration:none;font-size:12px;opacity:0.6;transition:opacity 0.2s ease;cursor:pointer" onclick="createIssue('bug')"> Report Bug </a>
      <span style="color:var(--muted);font-size:12px;opacity:0.6">|</span>
      <a href="#" style="color:var(--muted);text-decoration:none;font-size:12px;opacity:0.6;transition:opacity 0.2s ease;cursor:pointer" onclick="createIssue('enhancement')"> Request Feature </a>
    </div>
    <header>
      <svg width="32" height="32" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M140 300 C200 180, 312 332, 372 212" stroke="#5E81AC" stroke-width="24" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
        <rect x="356" y="356" width="120" height="28" rx="14" transform="rotate(45 356 356)" fill="#2E3440"/>
      </svg>
      <h1>Profilis</h1>
